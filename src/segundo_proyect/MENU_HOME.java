...
public class MENU_HOME extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(cerrar_sesion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE)
        ...
        jLabel5.setText("0 / 140 caracteres");
...
//
    private void tweetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tweetActionPerformed
        ...
        if (!texting.getText().trim().isEmpty() && texting.getText().length() <= 140) {
        ...
        } else if (texting.getText().length() > 140) {
            JOptionPane.showMessageDialog(this, "No se permite más de 140 caracteres.", "Error", JOptionPane.ERROR_MESSAGE);
