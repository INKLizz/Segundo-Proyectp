...
public class Profile_otro_usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        followyunfollow = new javax.swing.JToggleButton();
        ...
        getContentPane().add(followers, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 300, 130, 30));
        ...
        getContentPane().add(following, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 360, 150, -1));
        ...
        followyunfollow.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        followyunfollow.setText("FOLLOW/ UNFOLLOW");
        followyunfollow.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                followyunfollowMouseClicked(evt);
            }
        });
        getContentPane().add(followyunfollow, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 410, 230, -1));
    ...
    if (user != null) {
     ...
     private void actualizarTwits() {
        ...
        String totalTweets = twitsOtroUsuario.MostrarMiTweets();
    ...
    private javax.swing.JToggleButton followyunfollow;
